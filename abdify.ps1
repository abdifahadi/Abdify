...
function Write-Header {
    ...
    Write-Host '      Official Final Fix - Version 4.0' -ForegroundColor 'White'
    Write-Host '---------------------------------------------------' -ForegroundColor 'Cyan'
}
...
Write-Host 'ABDIFY THEME: Downloading V4.0 assets...' -ForegroundColor Cyan
...
# Use Start-Process to avoid using the ampersand operator in case it causes issues
...
Write-Host '   ABDIFY ACTIVATED SUCCESSFULLY! (V4.0) ' -ForegroundColor Green
Write-Host '---------------------------------------------------' -ForegroundColor Green
