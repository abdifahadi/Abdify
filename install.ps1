# ---------------------------------------------------------
# ABDIFY ULTIMATE REPAIR AND CLEANER V3.8
# ---------------------------------------------------------
...
function Write-Header {
    ...
    Write-Host "      Deep Analysis Fix - Version 3.8" -ForegroundColor "White"
    Write-Host "---------------------------------------------------" -ForegroundColor "Cyan"
}
...
Write-Host "ABDIFY THEME: Downloading V3.8 assets..." -ForegroundColor Cyan
...
# Using Start-Process to avoid using the ampersand operator in case it causes issues
...
Write-Host "   ABDIFY V3.8 INSTALLED SUCCESSFULLY!   " -ForegroundColor Green
Write-Host "---------------------------------------------------" -ForegroundColor Green
